...
public class NumberUtil {
     ...
     * @since JDK 1.5
     */
    public NumberUtil(BigDecimal dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
     ...
     * @since JDK 1.5
     */
    public NumberUtil(double dec) throws NumberFormatException {
        this();
        setNumber(dec);
    }
    ...
    public static void main(String[] args) throws NumberFormatException {
    	...
    	NumberUtil teste = new NumberUtil(new BigDecimal(10));
