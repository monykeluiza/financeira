...
CREATE TABLE `documento` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_documento_cliente1_idx` (`cliente_id`),
  KEY `fk_documento_tipo_documento1_idx` (`tipo_documento_id`),
  CONSTRAINT `fk_documento_cliente1` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2019-07-01 11:25:50
